...
define(
    ['stylesheet!css/ui/slides/slide-element', 'jquery', 'underscore', 'backbone', 'mustache', 'text!templates/slides/SlideElement.mu', 'ckeditor'],
    function (css, $, _, Backbone, Mustache, template, CKEditor) {
